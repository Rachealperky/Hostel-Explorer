...
class __TwigTemplate_bfe18c0f660939044e7786d28866cda0 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "/Users/olara/Developer/Class/Project/HostelExplorer/Hostel-Explorer/core/themes/claro/templates/filter/filter-tips.html.twig");
    }
